...
const Service = () => {
    return (
        <section className="w-4/5 m-auto mt-20 text-white text-center">
            <h1 className="uppercase text-cyan-100 font-logoFont text-center py-2 font-semibold text-6xl bg-gradient-to-r from-amber-500 to-pink-500 rounded-md opacity-70">
                Services
            </h1>
            <div className="my-10 grid grid-cols-3 w-4/5 m-auto">
